...
import { InputField } from 'FreeCoRE/Components/InputField';
import { Button, Input, Col, Label, FormGroup, Container, Row, Alert } from 'reactstrap';
import { attemptRegistration } from 'FreeCoRE/Actions/Auth';
import { Option } from 'ts-option';
import { AlertRow } from 'FreeCoRE/Components/AlertRow';
